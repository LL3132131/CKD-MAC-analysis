# =============================================================================
# Title: scRNA_processing_utils.R
# Purpose: `target_cellrepot_way.R`
...
# Required inputs: Expression matrix and cell metadata passed by caller
# Generated outputs: Correlation data frames and plot helpers
# Upstream dependencies: Expression matrix and cell metadata passed by caller
# Downstream consumers: `target_cellrepot_way.R`
...
# Example run command: Rscript scripts/05_Validation/scRNA_processing_utils.R
